...
<div class="page-header">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.categories') }}">Categorias</a></li>
    ...
    <form method="POST" action="{{ route('admin.saveCategory') }}" id="categoryForm">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-4">
          <label class="form-control-label">Nome Categoria <span class="required">*</span></label>
        ...
        <div class="form-group col-md-4">
          <label class="form-control-label">Adicionar Icone <span class="required">*</span></label>
