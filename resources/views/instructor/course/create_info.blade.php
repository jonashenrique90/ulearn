    ...
    <form method="POST" action="{{ route('instructor.course.info.save') }}" id="courseForm">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-4">
            <label class="form-control-label">Título do Curso <span class="required">*</span></label>
            <input type="text" class="form-control" name="course_title"
                placeholder="Tútulo" value="{{ $course->course_title }}" />
        ...
        <div class="form-group col-md-4">
            <label class="form-control-label">Nível <span class="required">*</span></label>
        ...
        <div class="form-group col-md-4">
            <label class="form-control-label">Preço <i class="fa fa-info-circle" data-toggle="tooltip" data-original-title="Leave blank if the course is free"></i></label>
            <input type="number" class="form-control" name="price"
                placeholder="Course Price" value="{{ $course->price }}" />
        </div>

        <div class="form-group col-md-4">
            <label class="form-control-label">Desconto <i class="fa fa-info-circle" data-toggle="tooltip" data-original-title="Applied only for paid courses"></i></label>
