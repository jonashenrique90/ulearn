        ...
        <div class="breadcrumb-container">
            <div class="container">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('my.courses') }}">Meu Curso</a></li>
                    ...
                    <div class="row cv-header">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 float-md-right col-sm-6 float-sm-right col-6">
                            <div class="cv-category-detail cv-enroll float-lg-right float-md-right float-sm-right">
                                <a href="javascript::void(0);" class="btn btn-ulearn-cview mt-1" data-toggle="modal" data-target="#rateModal">Classificar</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 d-none d-md-block">
                <section class="course-feature">
                    ...
                    <ul class="list-unstyled cf-pricing-li">
                        <li><i class="far fa-user"></i>{{ $students_count }} Estudantes</li>
                        ...
                        <li><i class="fas fa-file-download"></i>Recursos para download</li>
                    </ul>
                </section>
