    ...
    <div class="container">
        <div class="row mt-4">
            ...
            <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    <div class="row cv-header">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 float-md-right col-sm-6 float-sm-right col-6">
                            <div class="cv-category-detail cv-enroll float-lg-right float-md-right float-sm-right">
                                <a href="{{ route('course.checkout', $course->course_slug) }}" class="btn btn-ulearn-cview mt-1">MATRICULAR-SE</a>
                            </div>
                        </div>
                    </div>
                    ...
                    @if($course->overview)
                        <h4 class="mt-4">Descrição do Curso</h4>
                        {!! $course->overview !!}
                    @endif
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 d-none d-md-block">
                <section class="course-feature">
                    ...
                    <ul class="list-unstyled cf-pricing-li">
                        <li><i class="far fa-user"></i>199 Estudantes</li>
                        <li><i class="far fa-clock"></i>Duração: {{ $course->duration ? $course->duration : '-' }}</li>
                        <li><i class="fas fa-bullhorn"></i>Tópicos: {{ $lectures_count }}</li>
                        <li><i class="far fa-play-circle"></i>Videos: {{ $videos_count }}</li>
                        <li><i class="far fa-address-card"></i>Certificado de conclusão</li>
                        <li><i class="fas fa-file-download"></i>Arquivos para Download</li>s
                    </ul>
                </section>

                @if($video)
                <h6 class="underline-heading mt-3">Introdução</h6>
                ...
                <h6 class="mt-4 underline-heading">Cursos por Categorias</h6>
